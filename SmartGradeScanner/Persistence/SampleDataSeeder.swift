...
/// The fixed OMR answer sheet this app is built around: 904×1280 portrait,
  /// exactly 20 questions × 5 bubbles (A–E left to right), 8 registration
  ...
  static func fixedOMRTemplate() -> TemplateDefinition {
    let bubbleWidth = 30.0 / 904.0   // printed diameter ≈ 30 px
    ...
    let bottomY = [668.0, 715.0, 760.0, 807.0, 857.0, 903.0, 948.0, 997.0, 1042.0, 1091.0]
      .map { $0 / 1280.0 }
    ...
    let digitRowsY = [706.0, 748.0, 790.0, 833.0, 876.0, 917.0, 960.0, 1002.0, 1044.0, 1085.0]
      .map { $0 / 1280.0 }
